...
PIPELINE_NAME=${PIPELINE_NAME:-"docker-boshrelease-base-image"}
...
vault read -field=value -tls-skip-verify secret/idefix/concourse/docker-boshrelease-base-image > ${CREDENTIALS}
